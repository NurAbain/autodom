...
if (!target || process.argv.length !== 3) {
  ...
  const allowed = new Set(["autodom-bot", "autodom-full-bot", "autodom-worker", "autodom-vin", "autodom-outreach"]);
  const seen = new Set();
  ...
  if (seen.size !== allowed.size) throw new Error("All five Autodom jobs are required");
